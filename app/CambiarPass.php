...
session_start();//inicio de sesion
    ...
    if(!isset($_SESSION["Correo"])){
        ...
        header('Location: ../Registro/index.php'); //Agregamos el producto
    }
    ...
    $sql = "SELECT u.id IDUsuario, c.id IDCodigo FROM codigo_update_pass c 
        JOIN usuario u ON c.f_idusuario = u.id WHERE u.email = '".$Email."' 
    ...
    if($Cont > 0){
        ...
        if($resultado2 == true){
            ...
            $_SESSION["Alerta"] = "passUpdate"; //Pass actualizada cprrectamente
            header('Location: ../Registro/index.php'); //Agregamos el producto
        }else{
        ...
        header('Location: ../Registro/CambiarPass.php'); //Agregamos el producto
    }
?>